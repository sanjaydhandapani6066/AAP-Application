...
import img1 from '../assets/images/7109473.jpg'
import img2 from '../assets/images/7109776.jpg'
...
const Home = () => {
  ...
  return (
    <>
      <Navbar />&ensp; &ensp;&ensp; &ensp;&ensp; &ensp;
        <br />
        <br />
                <hr />    
        ...
        <div className=" container mt-3">
          <div className="row">
            <div className="col-6 mt-5 align-items-center justify-content-center">
              <div className=" ">
                <h1>
                  <span className='disabled'>Welcome to our Yoga Academy Platform </span> <span className="uppercase-text">zenvista</span>
                </h1>
                &ensp; &ensp;
          ...
          <div className="row">
            <div className='col-6 mt-4 mb-4 d-flex align-items-center '>
